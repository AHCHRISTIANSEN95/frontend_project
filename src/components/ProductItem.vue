...
<div v-if="activetab === 1" class="tabcontent">
     <div v-for="product in products" :key="product.id" class="product-item" :to="`/product/${product.id}`">
        ...
        <div class="product-item__thumbnail">
                <img class="product-item__img--thumbnail" :src="product.thumb1" alt="thumbnail back">
                <img class="product-item__img--thumbnail" :src="product.thumb2" alt="thumbnail front">
            </div>
