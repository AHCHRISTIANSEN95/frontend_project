    ...
    <div class="sign-up padding-b-60">
        ...
        <section class="sign-up__container">
            <form class="signin" action="/signin" method="post" @submit="checkForm">
                ...
                <input id="email" v-model="semail" name="email" required="required" class="signin__email" placeholder="Your email..."
                    type="email">
                <input id="password" v-model="spassword" name="password" required="required" class="signin__password"
            ...
            <form class="register" action="/register" method="post" @submit="checkFormRegisteration">
                ...
                <input v-model="remail" name="email" required="required" class="register__email" type="email"
                ...
                <span class="register__account"><input class="register__checkbox" type="checkbox">
                    <p class="register__checkboxtext">Sign up for exclusive updates, discounts, new arrivals, contests,
                        and more!</p>
                </span>
                <button value="Submit" type="submit" class="register__button primary-btn">Create account</button>
                 <span class="register__agree">
                    <p> By clicking ‘Create Account’, you agree to our <a href="#">Pricay Policy<i class="fas fa-long-arrow-alt-right"></i></a></p>
                </span>
            </form>
        </section>
    </div>
